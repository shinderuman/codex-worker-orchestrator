...
func TestExecuteStatusProjectsMilestoneProgressWithoutModelCall(t *testing.T) {
	...
	plan := fmt.Sprintf(`{"version":1,"task_id":%q,"active_task_path":"IMPLEMENTATION_TASKS/large.md","task_contract_sha256":"digest","current_index":1,"milestones":[{"id":"one","scope":"one","acceptance":"one","status":"complete"},{"id":"two","scope":"two","acceptance":"two","status":"pending"},{"id":"three","scope":"three","acceptance":"three","status":"pending"}],"updated_at":"2026-09-21T00:00:00Z"}`, taskID)
