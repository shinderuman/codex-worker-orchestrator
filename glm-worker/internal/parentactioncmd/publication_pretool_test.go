...
func TestPublicationPreToolUseBlocksGitGuardBypass(t *testing.T) {
	commands := []string{
		...
		"command -p git push origin main --no-verify",
		"command -- git push origin main --no-verify",
		"exec -a worker git push origin main --no-verify",
		...
		"(git push origin main --no-verify)",
		"{ git push origin main --no-verify; }",
		"if true; then git push origin main --no-verify; fi",
		"while git push origin main --no-verify; do break; done",
		"case x in x) git push origin main --no-verify ;; esac",
		"git push origin main --no-\"verify\"",
		"git commit --no-'verify' -m bypass",
