...
type ModelCallLog struct {
	...
	ConfiguredAutoCompactWindowTokens int                           `json:"configured_auto_compact_window_tokens,omitempty"`
	KnownModelContextWindowTokens     int                           `json:"known_model_context_window_tokens,omitempty"`
	DeclaredMaxContextWindowTokens    int                           `json:"declared_max_context_window_tokens,omitempty"`
