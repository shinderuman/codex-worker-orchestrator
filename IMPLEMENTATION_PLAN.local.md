...
- current implementation: 010 `task-splitting-milestones`はACTIVE。F9 integration `948ea31ee4381f4192afeff607c015696349a9a1`から専用branch `hardening-task/task-splitting-milestones`を開始済み
...
010開始を妨げるdependency / permission waitはない。

## 次の親Codex操作

Task 009の再現可能outlier evidenceと導入後telemetryを棚卸しし、task責務分割・semantic milestone・resume boundaryがCodex Reduction / Quality Delta / additional review callsへ与える差を比較して、hard capを置かない採否条件を確定する。
