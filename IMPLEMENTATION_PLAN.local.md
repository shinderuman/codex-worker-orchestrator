...
PR #15のruntime証跡込みfinal treeを恒久Repository Lintで確認し、PR本文を最終証跡へ同期してready化し、`hardening/agent-guardrails`へSquash Mergeする。その後latest integrationを予約済みF6 branchへ履歴を書き換えず同期し、Rules / Plan / ACTIVE F6 taskを再読してF6を開始する。
