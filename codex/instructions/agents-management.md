...
- `glm-codex-context`で他repositoryへglm-worker用contextを有効化する場合は、tool-owned project-scoped bootstrapからinstalled namespaced instructionへ到達させ、global AGENTSへruleを戻さない。
