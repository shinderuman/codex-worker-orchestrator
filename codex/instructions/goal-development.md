...
- GLM provider rate limit・provider停止は`glm-execution.md`、Codex 5h limitは`codex-auto-resume.md`を使う。session終了・compaction後は`codex/AGENTS.md`のcanonical authority bootstrap contractへ戻り、同じprojectを継続する
