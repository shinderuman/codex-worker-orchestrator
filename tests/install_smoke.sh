...
grep -Fq '        ["start", "decision", "fix", "start-milestones", "revise-milestones", "no-go", "accept", "resume", "finalize-check"],' "$home/.codex/rules/glm-worker.rules"
grep -Fq '        ["glm-parent-action", "prepare", "decision"],' "$home/.codex/rules/glm-worker.rules"
